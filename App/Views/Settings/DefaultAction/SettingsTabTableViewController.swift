...
class SettingsTabTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        myBarcodeMatomo.track(action: myBarcodeMatomo.settingsAction, name: myBarcodeMatomo.settingsDefaultTabAction)
    }
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return myBarcode.tabValues.count
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        guard let tabForRow = TabOption(rawValue: row), let cellLabel = myBarcode.tabValues[tabForRow] else {
            fatalError()
        }
